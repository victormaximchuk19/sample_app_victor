...
class PasswordResetsTest < ActionDispatch::IntegrationTest
  ...
  test "password resets" do
    ...
    patch password_reset_path(user.reset_token), params: { email: user.email, user: { password: "foobar", password_confirmation: "fooqwerty" } }
    ...
    # Checks for reset_digest value reset
